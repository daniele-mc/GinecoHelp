...
var OpcoesPage = /** @class */ (function () {
    function OpcoesPage(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    OpcoesPage.prototype.ngOnInit = function () {
    };
    OpcoesPage.prototype.saudeVaginal = function () {
        return this.router.navigate(["/saude-vaginal"]);
    };
    OpcoesPage.prototype.cicloMenstrual = function () {
        return this.router.navigate(["/ciclo-menstrual"]);
    };
    OpcoesPage.prototype.metodoContraceptivo = function () {
        return this.router.navigate(["/metodo-contraceptivo"]);
    };
    OpcoesPage.prototype.sexo = function () {
        return this.router.navigate(["/sexo"]);
    };
    OpcoesPage.prototype.servicosSaude = function () {
        return this.router.navigate(["/servicos-saude"]);
    };
    OpcoesPage.prototype.logout = function () {
    ...
    OpcoesPage.ctorParameters = function () { return [
