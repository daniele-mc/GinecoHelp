...
var CicloMenstrualTresPage = /** @class */ (function () {
    function CicloMenstrualTresPage(healthService, loadingCtrl, toastCtrl, authService, activeRoute, router) {
    ...
    CicloMenstrualTresPage.prototype.formattingDay = function () {
        var format = new Date();
        var day;
        var month;
    ...
    CicloMenstrualTresPage.prototype.check = function () {
    ...
    CicloMenstrualTresPage.prototype.loadHealth = function () {
        var _this = this;
        this.healthSubscription = this.healthService.getHealth(this.today).subscribe(function (data) {
            _this.health = data;
        });
    };
    CicloMenstrualTresPage.prototype.back = function () {
        this.saveHealth();
        return this.router.navigate(["/sintomas"]);
    };
    CicloMenstrualTresPage.prototype.menu = function () {
        this.saveHealth();
        return this.router.navigate(["/opcoes"]);
    };
    CicloMenstrualTresPage.prototype.next = function () {
        this.saveHealth();
        return this.router.navigate(["/metodo-contraceptivo"]);
    };
    CicloMenstrualTresPage.prototype.saveHealth = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CicloMenstrualTresPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    CicloMenstrualTresPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CicloMenstrualTresPage.ctorParameters = function () { return [
