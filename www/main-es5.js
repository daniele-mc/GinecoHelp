...
var routes = [
    ...
    { path: 'objetivos', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-objetivos-objetivos-module */ "pages-objetivos-objetivos-module").then(__webpack_require__.bind(null, /*! ./pages/objetivos/objetivos.module */ "./src/app/pages/objetivos/objetivos.module.ts")).then(function (m) { return m.ObjetivosPageModule; }); }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_4__["LoginGuard"]] },
    { path: 'cadastro', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-cadastro-cadastro-module */ "pages-cadastro-cadastro-module").then(__webpack_require__.bind(null, /*! ./pages/cadastro/cadastro.module */ "./src/app/pages/cadastro/cadastro.module.ts")).then(function (m) { return m.CadastroPageModule; }); }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_4__["LoginGuard"]] },
    { path: 'login', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-login-login-module */ "pages-login-login-module").then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_4__["LoginGuard"]] },
    { path: 'opcoes', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-opcoes-opcoes-module */ "pages-opcoes-opcoes-module").then(__webpack_require__.bind(null, /*! ./pages/opcoes/opcoes.module */ "./src/app/pages/opcoes/opcoes.module.ts")).then(function (m) { return m.OpcoesPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'saude-vaginal', loadChildren: function () { return Promise.all(/*! import() | pages-saude-vaginal-saude-vaginal-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-saude-vaginal-saude-vaginal-module")]).then(__webpack_require__.bind(null, /*! ./pages/saude-vaginal/saude-vaginal.module */ "./src/app/pages/saude-vaginal/saude-vaginal.module.ts")).then(function (m) { return m.SaudeVaginalPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'saude-vaginal-dicas', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-saude-vaginal-dicas-saude-vaginal-dicas-module */ "pages-saude-vaginal-dicas-saude-vaginal-dicas-module").then(__webpack_require__.bind(null, /*! ./pages/saude-vaginal-dicas/saude-vaginal-dicas.module */ "./src/app/pages/saude-vaginal-dicas/saude-vaginal-dicas.module.ts")).then(function (m) { return m.SaudeVaginalDicasPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'saude-vaginal-dois', loadChildren: function () { return Promise.all(/*! import() | pages-saude-vaginal-dois-saude-vaginal-dois-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-saude-vaginal-dois-saude-vaginal-dois-module")]).then(__webpack_require__.bind(null, /*! ./pages/saude-vaginal-dois/saude-vaginal-dois.module */ "./src/app/pages/saude-vaginal-dois/saude-vaginal-dois.module.ts")).then(function (m) { return m.SaudeVaginalDoisPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'saude-vaginal-dois-dicas', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-saude-vaginal-dois-dicas-saude-vaginal-dois-dicas-module */ "pages-saude-vaginal-dois-dicas-saude-vaginal-dois-dicas-module").then(__webpack_require__.bind(null, /*! ./pages/saude-vaginal-dois-dicas/saude-vaginal-dois-dicas.module */ "./src/app/pages/saude-vaginal-dois-dicas/saude-vaginal-dois-dicas.module.ts")).then(function (m) { return m.SaudeVaginalDoisDicasPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'saude-relacoes', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-saude-relacoes-saude-relacoes-module */ "pages-saude-relacoes-saude-relacoes-module").then(__webpack_require__.bind(null, /*! ./pages/saude-relacoes/saude-relacoes.module */ "./src/app/pages/saude-relacoes/saude-relacoes.module.ts")).then(function (m) { return m.SaudeRelacoesPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'higiene', loadChildren: function () { return Promise.all(/*! import() | pages-higiene-higiene-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-higiene-higiene-module")]).then(__webpack_require__.bind(null, /*! ./pages/higiene/higiene.module */ "./src/app/pages/higiene/higiene.module.ts")).then(function (m) { return m.HigienePageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'higiene-dois', loadChildren: function () { return Promise.all(/*! import() | pages-higiene-dois-higiene-dois-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-higiene-dois-higiene-dois-module")]).then(__webpack_require__.bind(null, /*! ./pages/higiene-dois/higiene-dois.module */ "./src/app/pages/higiene-dois/higiene-dois.module.ts")).then(function (m) { return m.HigieneDoisPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'higiene-tres', loadChildren: function () { return Promise.all(/*! import() | pages-higiene-tres-higiene-tres-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-higiene-tres-higiene-tres-module")]).then(__webpack_require__.bind(null, /*! ./pages/higiene-tres/higiene-tres.module */ "./src/app/pages/higiene-tres/higiene-tres.module.ts")).then(function (m) { return m.HigieneTresPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'ciclo-menstrual', loadChildren: function () { return Promise.all(/*! import() | pages-ciclo-menstrual-ciclo-menstrual-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-ciclo-menstrual-ciclo-menstrual-module")]).then(__webpack_require__.bind(null, /*! ./pages/ciclo-menstrual/ciclo-menstrual.module */ "./src/app/pages/ciclo-menstrual/ciclo-menstrual.module.ts")).then(function (m) { return m.ClicoMenstrualPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'ciclo-menstrual-dois', loadChildren: function () { return Promise.all(/*! import() | pages-ciclo-menstrual-dois-ciclo-menstrual-dois-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-ciclo-menstrual-dois-ciclo-menstrual-dois-module")]).then(__webpack_require__.bind(null, /*! ./pages/ciclo-menstrual-dois/ciclo-menstrual-dois.module */ "./src/app/pages/ciclo-menstrual-dois/ciclo-menstrual-dois.module.ts")).then(function (m) { return m.CicloMenstrualDoisPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'metodo-contraceptivo', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-metodo-contraceptivo-metodo-contraceptivo-module */ "pages-metodo-contraceptivo-metodo-contraceptivo-module").then(__webpack_require__.bind(null, /*! ./pages/metodo-contraceptivo/metodo-contraceptivo.module */ "./src/app/pages/metodo-contraceptivo/metodo-contraceptivo.module.ts")).then(function (m) { return m.MetodoContraceptivoPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'uso-contracep', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-uso-contracep-uso-contracep-module */ "pages-uso-contracep-uso-contracep-module").then(__webpack_require__.bind(null, /*! ./pages/uso-contracep/uso-contracep.module */ "./src/app/pages/uso-contracep/uso-contracep.module.ts")).then(function (m) { return m.UsoContracepPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'uso-adolecentes', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-uso-adolecentes-uso-adolecentes-module */ "pages-uso-adolecentes-uso-adolecentes-module").then(__webpack_require__.bind(null, /*! ./pages/uso-adolecentes/uso-adolecentes.module */ "./src/app/pages/uso-adolecentes/uso-adolecentes.module.ts")).then(function (m) { return m.UsoAdolecentesPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'uso-emergencia', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-uso-emergencia-uso-emergencia-module */ "pages-uso-emergencia-uso-emergencia-module").then(__webpack_require__.bind(null, /*! ./pages/uso-emergencia/uso-emergencia.module */ "./src/app/pages/uso-emergencia/uso-emergencia.module.ts")).then(function (m) { return m.UsoEmergenciaPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'ciclo-menstrual-tres', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-ciclo-menstrual-tres-ciclo-menstrual-tres-module */ "pages-ciclo-menstrual-tres-ciclo-menstrual-tres-module").then(__webpack_require__.bind(null, /*! ./pages/ciclo-menstrual-tres/ciclo-menstrual-tres.module */ "./src/app/pages/ciclo-menstrual-tres/ciclo-menstrual-tres.module.ts")).then(function (m) { return m.CicloMenstrualTresPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'sintomas', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-sintomas-sintomas-module */ "pages-sintomas-sintomas-module").then(__webpack_require__.bind(null, /*! ./pages/sintomas/sintomas.module */ "./src/app/pages/sintomas/sintomas.module.ts")).then(function (m) { return m.SintomasPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'sexo', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-sexo-sexo-module */ "pages-sexo-sexo-module").then(__webpack_require__.bind(null, /*! ./pages/sexo/sexo.module */ "./src/app/pages/sexo/sexo.module.ts")).then(function (m) { return m.SexoPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'gravidez', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-gravidez-gravidez-module */ "pages-gravidez-gravidez-module").then(__webpack_require__.bind(null, /*! ./pages/gravidez/gravidez.module */ "./src/app/pages/gravidez/gravidez.module.ts")).then(function (m) { return m.GravidezPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'desejo-sexual', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-desejo-sexual-desejo-sexual-module */ "pages-desejo-sexual-desejo-sexual-module").then(__webpack_require__.bind(null, /*! ./pages/desejo-sexual/desejo-sexual.module */ "./src/app/pages/desejo-sexual/desejo-sexual.module.ts")).then(function (m) { return m.DesejoSexualPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'servicos-saude', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-servicos-saude-servicos-saude-module */ "pages-servicos-saude-servicos-saude-module").then(__webpack_require__.bind(null, /*! ./pages/servicos-saude/servicos-saude.module */ "./src/app/pages/servicos-saude/servicos-saude.module.ts")).then(function (m) { return m.ServicosSaudePageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    {
        path: 'redefinir-senha',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-redefinir-senha-redefinir-senha-module */ "pages-redefinir-senha-redefinir-senha-module").then(__webpack_require__.bind(null, /*! ./pages/redefinir-senha/redefinir-senha.module */ "./src/app/pages/redefinir-senha/redefinir-senha.module.ts")).then(function (m) { return m.RedefinirSenhaPageModule; }); }
    },
];
...
/* harmony import */ var ion2_calendar__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ion2-calendar */ "./node_modules/ion2-calendar/dist/index.js");
/* harmony import */ var ion2_calendar__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(ion2_calendar__WEBPACK_IMPORTED_MODULE_19__);
...
/* harmony import */ var _logisticinfotech_ionic4_datepicker__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @logisticinfotech/ionic4-datepicker */ "./node_modules/@logisticinfotech/ionic4-datepicker/fesm5/logisticinfotech-ionic4-datepicker.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            imports: [
                ...
                ion2_calendar__WEBPACK_IMPORTED_MODULE_19__["CalendarModule"],
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        return new Promise(function (resolve) {
            _this.authService.getAuth().onAuthStateChanged(function (user) {
                ...
                if (!user)
                    _this.router.navigate(['objetivos']);
...
var LoginGuard = /** @class */ (function () {
    ...
    LoginGuard.prototype.canActivate = function () {
        ...
        return new Promise(function (resolve) {
            _this.authService.getAuth().onAuthStateChanged(function (user) {
                // se estiver logado vai p/ opcoes
                // criou uma conta ou logou vai p/ opcoes
                if (user)
                    _this.router.navigate(['opcoes']);
                resolve(!user ? true : false);
            });
        });
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.resetPassword = function (email) {
        return this.afa.auth.sendPasswordResetEmail(email).then(function () { return console.log("Email enviado"); })
...
module.exports = __webpack_require__(/*! /home/dani/Documents/bolsa/ap/GinecoHelp/src/main.ts */"./src/main.ts");
