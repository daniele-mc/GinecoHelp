...
var UsoEmergenciaPageRoutingModule = /** @class */ (function () {
    function UsoEmergenciaPageRoutingModule() {
    }
    ...
    return UsoEmergenciaPageRoutingModule;
}());
...
var UsoEmergenciaPageModule = /** @class */ (function () {
    function UsoEmergenciaPageModule() {
    }
    ...
    return UsoEmergenciaPageModule;
}());
...
var UsoEmergenciaPage = /** @class */ (function () {
    function UsoEmergenciaPage(AlertController, healthService, loadingCtrl, toastCtrl, authService, activeRoute, router) {
    ...
    UsoEmergenciaPage.prototype.presentAlert1 = function () {
    ...
    UsoEmergenciaPage.prototype.ngOnInit = function () {
        this.formattingDay();
        this.check();
    };
    UsoEmergenciaPage.prototype.formattingDay = function () {
        var format = new Date();
        var day;
        var month;
    ...
    UsoEmergenciaPage.prototype.check = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UsoEmergenciaPage.prototype.loadHealth = function () {
        var _this = this;
        this.healthSubscription = this.healthService.getHealth(this.today).subscribe(function (data) {
            _this.health = data;
        });
    };
    UsoEmergenciaPage.prototype.back = function () {
        this.saveHealth();
        return this.router.navigate(["/uso-adolecentes"]);
    };
    UsoEmergenciaPage.prototype.menu = function () {
        this.saveHealth();
        return this.router.navigate(["/opcoes"]);
    };
    UsoEmergenciaPage.prototype.next = function () {
        this.saveHealth();
        return this.router.navigate(["/sexo"]);
    };
    UsoEmergenciaPage.prototype.saveHealth = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UsoEmergenciaPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    UsoEmergenciaPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UsoEmergenciaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-uso-emergencia-uso-emergencia-module-es5.js.map