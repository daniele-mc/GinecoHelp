...
var UsoAdolecentesPage = /** @class */ (function () {
    function UsoAdolecentesPage(AlertController, healthService, loadingCtrl, toastCtrl, authService, activeRoute, router) {
    ...
    UsoAdolecentesPage.prototype.formattingDay = function () {
        var format = new Date();
        var day;
        var month;
    ...
    UsoAdolecentesPage.prototype.check = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UsoAdolecentesPage.prototype.loadHealth = function () {
        var _this = this;
        this.healthSubscription = this.healthService.getHealth(this.today).subscribe(function (data) {
            _this.health = data;
        });
    };
    UsoAdolecentesPage.prototype.back = function () {
        this.saveHealth();
        return this.router.navigate(["/metodo-contraceptivo"]);
    };
    UsoAdolecentesPage.prototype.menu = function () {
        this.saveHealth();
        return this.router.navigate(["/opcoes"]);
    };
    UsoAdolecentesPage.prototype.next = function () {
        this.saveHealth();
        return this.router.navigate(["/uso-emergencia"]);
    };
    UsoAdolecentesPage.prototype.saveHealth = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UsoAdolecentesPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    UsoAdolecentesPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
