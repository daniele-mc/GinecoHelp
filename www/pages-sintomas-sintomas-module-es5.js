...
var SintomasPage = /** @class */ (function () {
    function SintomasPage(AlertController, healthService, loadingCtrl, toastCtrl, authService, activeRoute, router) {
    ...
    SintomasPage.prototype.formattingDay = function () {
        var format = new Date();
        var day;
        var month;
    ...
    SintomasPage.prototype.check = function () {
    ...
    SintomasPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    SintomasPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SintomasPage.ctorParameters = function () { return [
